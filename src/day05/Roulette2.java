...
public class Roulette2 {
    public static void main(String[] args) {
        ...
        // 플레이어의 이름을 반복해서 입력받고 배열에 차례로 저장
        ...
        // 실탄 수 검증
        if (bulletNum == 0 || bulletNum >= 6) {
            System.out.println("실탄 개수가 올바르지 않습니다. GAME OVER!!");
            return;
        }
...
//        System.out.println("탄창: " + Arrays.toString(magazine));
        ...
        System.out.printf("\n총을 돌렸습니다. %s부터 시작합니다.", players[startIdx]);
        ...
        while (true) {
            ...
            System.out.print("# 엔터를 누르면 격발합니다.");

            // 엔터만을 입력 받고 끝내려면 nextLine()을 단독으로 사용.
            sc.nextLine();
            ...
            if (magazine[bulletPos]) {
                ...
                if (playerNum == 1) {
                    System.out.println("단 한 명만 살아남았습니다. 게임을 종료합니다.");
                    System.out.println("최후 생존자: " + Arrays.toString(players));
                    break;
                } else {
                    System.out.println("\n남은 인원으로 게임을 계속합니다.");
